...
import com.basic.app.acl.auth.repository.UserRoleRepository;
...
public class ProfileController {
    ...
    public String userProfileUpdate( User tnxUser, RedirectAttributes redirAttrs ) {
        ...
        if(entityOptional.isPresent()) {
            ...
            editUser.setExpertiseArea(tnxUser.getExpertiseArea());
            editUser.setPendingJobLimit(tnxUser.getPendingJobLimit());
